        ...
        <div class="row">
            <div class="col_12">
                <ul class="breadcrumbs hor-list">
                    <li><a href="<?php echo base_url();?>index.php/admin/newsletters_sent">Manage sent newsletters</a></li>
                </ul>
                <h1>Manage Sent Newsletters</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col_12">
            ...
            <div id="tableBody">
                ...
                <thead>
                    ...
                    <tbody>    
                        <?PHP
                                if(isset($newsletters_sent) && count($newsletters_sent) > 0)
                                {
                                    foreach($newsletters_sent as $newsletter)
                                    {
                            ?>
                            <tr class="gradeU">
                                ...
                                <td style="width: auto;"><?PHP echo long_date_format($newsletter['date_sent']);?></td>
                                <td>
