...
<?PHP 
    if(isset($site_users_data) && $site_users_data != false){
?>
        ...
        <div class="widget_inside">
            <div class="col_12">
                <table class="regular" style="padding: 3em;">
                    <tbody>
                        <?PHP 
                            if($site_users_data['first_name'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">User Name :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['first_name']))?> <?PHP echo ucfirst($site_users_data['last_name'])?></td>
                        </tr>
                        <?PHP }?>
                        
                         
                        <?PHP 
                            if($site_users_data['date_of_birth'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Date of Birth : </td>
                            <td><?PHP echo long_date_format($site_users_data['date_of_birth'])?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['email_address'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Email Address:</td>
                            <td><?PHP echo $site_users_data['email_address']?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['address1'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Address 1 :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['address1']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        
                        <?PHP 
                            if($site_users_data['address2'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Address 2 :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['address2']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['landmark1'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Landmark 1:</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['landmark1']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['landmark2'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">landmark 2 :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['landmark2']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['city'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">City :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['city']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['p_o_box'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">P.O Box :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['p_o_box']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['telephone'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Telephone :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['telephone']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['mobile'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Mobile :</td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['mobile']))?></td>
                        </tr>
                        <?PHP }?>
                       
                        <?PHP 
                            if($site_users_data['country_id'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Country : </td>
                            <td><?PHP echo ucfirst(stripcslashes($site_users_data['countries_name']))?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($site_users_data['register_date'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Register Date : </td>
                            <td><?PHP echo long_date_format($site_users_data['register_date'])?></td>
                        </tr>
                        <?PHP }?>
                    </tbody>
                </table>
