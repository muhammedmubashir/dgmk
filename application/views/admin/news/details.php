...
<?PHP 
    if(isset($news_data) && $news_data != false){
?>
        ...
        <div class="widget_inside">
            <div class="col_12">
                <table class="regular" style="padding: 3em;">
                    <tbody>
                        <?PHP 
                            if($news_data['news_title'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">News Title :</td>
                            <td><?PHP echo stripslashes($news_data['news_title'])?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($news_data['news_details'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%" style="vertical-align: top">News Details :</td>
                            <td><?PHP echo stripslashes($news_data['news_details'])?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($news_data['display_order'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Display Order:</td>
                            <td><?PHP echo $news_data['display_order']?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($news_data['news_date'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">News Date:</td>
                            <td><?PHP echo long_date_format($news_data['news_date'])?></td>
                        </tr>
                        <?PHP }?>
                        
                        <?PHP 
                            if($news_data['date_added'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">Creation Date:</td>
                            <td><?PHP echo long_date_format($news_data['date_added'])?></td>
                        </tr>
                        <?PHP }?>
                        
                         <?PHP 
                            if($news_data['news_status'] !="")
                            {
                        ?>
                        <tr>
                            <td width="25%">News Status:</td>
                            <td>
                            <?PHP
                            if($news_data['news_status'] == 1)
                            {
                                echo "Activate";
                            }
                            else
