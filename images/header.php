...
<div id="wrapper">
	...
	<div id="boxpopup" class="box">
		...
		<div id="content" style="text-align:center;">
			Listen Live Jalsa Hyderabad 2013
			<br>
			<a href="http://drghulammustafa.com/live/jalsa/al-mustafa-trust-hyderabad-2013.html">
				Click Here
			</a>
		</div>
	</div>
    ...
    <header id="header" class="container clearfix">
        ...
        <nav id="nav">
            <ul id="navlist" class="clearfix">
                ...
                <li><a href="#" rel="submenu3">Biyanat</a>
