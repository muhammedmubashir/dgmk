...
{ 
   ...
   return true;
    ...
    function isLifeLongOnChange(obj)
    {
       if(obj.checked)
       {
          $("#valid_to_month").attr('disabled', 'disabled'); 
          $("#valid_to_year").attr('disabled', 'disabled'); 
       }
       else                             
       {
          $("#valid_to_month").removeAttr('disabled');; 
          $("#valid_to_year").removeAttr('disabled');; 
       }
